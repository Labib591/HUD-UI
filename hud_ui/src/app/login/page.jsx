...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      switch (error) {
        case 'OAuthSignin':
          errorMessage = 'Google OAuth configuration error. Please check your environment variables.'
          break
        case 'OAuthCallback':
          errorMessage = 'Google OAuth callback error. Please try again.'
          break
        ...
        case 'OAuthAccountNotLinked':
          ...
          break
        case 'EmailSignin':
          errorMessage = 'Email sign-in error. Please check your email and try again.'
          break
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setErrors({ 
        general: "Google sign-in failed. Please check your environment variables and try again." 
      })
